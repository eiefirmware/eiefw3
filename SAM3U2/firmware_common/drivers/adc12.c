...
static fnCode_u16_type Adc12_apfCallbacks[U8_TOTAL_ADC_CHANNELS];                   /*!< @brief ADC12 ISR callback function pointers */
...
@brief An empty function that the unset ADC call-backs point to.  
