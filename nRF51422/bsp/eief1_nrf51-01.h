...
#define RTC_PRESCALE_INIT    (u32)31         /* (32768 / 10000) - 1 = 31 */
...
#define P0_11_ANT_SPI_SCK    (u32)0x00000800
...
#define LED_RED_BIT          (u32)29
#define LED_YLW_BIT          (u32)28
#define LED_GRN_BIT          (u32)27
#define LED_BLU_BIT          (u32)26 
#define TP65_BIT             (u32)16
#define NRF_POMI_BIT         (u32)15
#define NRF_PIMO_BIT         (u32)14
#define ANT_USPI2_MOSI_BIT   (u32)13
#define ANT_USPI2_MISO_BIT   (u32)12
#define ANT_USPI2_SCK_BIT    (u32)11
#define ANT_SEN_BIT          (u32)10
#define ANT_SRDY_BIT         (u32)9
#define ANT_MRDY_BIT         (u32)8
...
#define P0_10_ANT_SEN_CNF        ( (GPIO_PIN_CNF_DIR_Output       << GPIO_PIN_CNF_DIR_Pos)   | \
                                   (GPIO_PIN_CNF_INPUT_Disconnect << GPIO_PIN_CNF_INPUT_Pos) | \
                                   (GPIO_PIN_CNF_PULL_Disabled    << GPIO_PIN_CNF_PULL_Pos)  | \
                                   (GPIO_PIN_CNF_DRIVE_S0S1       << GPIO_PIN_CNF_DRIVE_Pos) | \
                                   (GPIO_PIN_CNF_SENSE_Disabled   << GPIO_PIN_CNF_SENSE_Pos) )
