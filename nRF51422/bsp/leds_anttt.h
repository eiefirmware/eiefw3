...
Type Definitions
******************************************************************************/
typedef enum {HOME1 = 0, HOME2, HOME3, HOME4, HOME5, HOME6, HOME7, HOME8, HOME9, 
              AWAY1, AWAY2, AWAY3, AWAY4, AWAY5, AWAY6, AWAY7, AWAY8, AWAY9,
              STATUS_RED, STATUS_YLW, STATUS_GRN} LedNumberType;
