/*!*********************************************************************************************************************
@file anttt_protocol.h    
@brief Header file for ANTTT game protocol

This header file should be included (and remain compatible) to all ANTTT
devices.  Any device-to-device communication shall reference this protocol
to ensure compatibility.

**********************************************************************************************************************/

#ifndef __ANTTTT_PROTOCOL_H
#define __ANTTTT_PROTOCOL_H
...
#define U8_ANTTT_STARTING_MESSAGE_NUMBER        (u8)0xA0
#define U8_ANTTT_ENDING_MESSAGE_NUMBER          (u8)0xAF
#define U8_ANTTT_MAX_MESSAGE_LENGTH             (u8)10
...
Whomever goes first is always X.
*/
